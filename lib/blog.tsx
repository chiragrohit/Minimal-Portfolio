  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Let's take background colors as an example. You don't write <code>bg-[#fafafa]</code>. You write <code>bg-background</code>. Under the hood, your CSS defines what <code>--background</code> means in different contexts.</p>
